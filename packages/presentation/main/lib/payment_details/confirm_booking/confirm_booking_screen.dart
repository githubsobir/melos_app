                  ...
                  children: [
                    Card(
                      ...
                      child: Padding(
                        padding: const EdgeInsets.all(16),
                        child: ItemCarImage(
                          imagePath: "$BASE_URL_IMAGE${state.contract.photo}",
                        ),
                      ),
                    ),
                    Card(
                          ...
                          children: [
                              ...
                              children: [
                                ClipRRect(
                                  ...
                                  child: CachedNetworkImage(
                                    imageUrl:
                                        "$BASE_URL_IMAGE/${state.contract.clientProfileImage}",
                                    width: 44,
                                    height: 44,
                                    fit: BoxFit.cover,
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                  "${state.contract.clientPhoneNumber}",
                                  style: Theme.of(context).textTheme.bodyMedium,
                                ),
                              ],
                            ),
